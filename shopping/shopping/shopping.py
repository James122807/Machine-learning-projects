...
def evaluate(labels, predictions):
    ...
    """
    positive = sum(1 for x in labels if x == 1)
    negative = sum(1 for x in labels if x == 0)
    ...
    sensitivity = true_positives/positive if positive else 0
    specificity = true_negatives/negative if negative else 0
